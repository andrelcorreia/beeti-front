  ...
  useEffect(() => {
    const fetchUsers = async () => {
      ...
      try {
        ...
        const response = await maintenanceRequest.listAll(
          token,
          page,
          limit,
          search
    ...
    fetchUsers();
  }, [page, limit, search, token, maintenanceRequest, router]);

  const handleUserClick = (maintenanceId: string) => {
    router.push(`/maintenanceDetails/${maintenanceId}`);
  };
  ...
  const handleExportReport = async () => {
    try {
      ...
      const response = await fetch(
        "http://localhost:3333/v1/reports/maintenance",
        {
          method: "GET",
          headers: {
      ...
      a.href = url;
      a.download = "relatorio_maintenance.xlsx";
      a.click();
  ...
  return (
    <div className="flex">
      ...
      <div className="flex-1 p-10">
        ...
        <h1 className="text-xl font-bold mb-5">Manutenções</h1>
